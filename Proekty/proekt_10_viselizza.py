...
def play():
    ...
    while mistakes < 6:
        while '_' in answer:
            ...
            print(f'Your progress: {"".join(answer)}. You', 'still ' * (mistakes < 6) + 'have',
                  'only ' * (mistakes == 5) + f'{6 - mistakes} attempt' + 's' * (mistakes != 5), 'left to survive.')
        ...
        next_game = input(
            f'''Although, in case you wanna die multiple times, the Game is always at your service, dear little {name}.
